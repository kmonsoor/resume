...
% Simplified format: % Khaled Monsoor (http://kmonsoor.com)
% Simplified repo: % https://github.com/kmonsoor/resume
...
%     TITLE NAME
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\namesection{}{Khaled Monsoor}
{ \urlstyle{same}\href{https://blog.kmonsoor.com}{blog.kmonsoor.com}    :: \href{mailto:k@kmonsoor.com}{k@kmonsoor.com}    ::    +65.4567.890\\
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%     LINKS
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\custombold{Automatons I brought in:}
\begin{tightemize}
...
\custombold{Solutions I built full-stack:}
\begin{tightemize}
...
\custombold{Tools I mostly used:}
...
\section{Skills}
\custombold{Languages }
Python \textbullet {JavaScript (Node.js)} \textbullet{ SQL} \textbullet Android / Java \textbullet{ HTML5}
\\
\custombold{Database } PostgreSQL \textbullet{MySQL} \textbullet{Redis} \textbullet{InfluxDB}
\\
\custombold{Deployment }
AWS \textbullet{Google Cloud} \textbullet{ TravisCI} \textbullet{ CentOS} Ubuntu \textbullet{ PM2} \textbullet{ Docker} \textbullet{ HAproxy} 
\\
\custombold{Web Tech } Express \textbullet{ Flask} \textbullet{ Django } \textbullet jQuery \textbullet{ Bootstrap} \textbullet{ webpack }
...
\smallskip
\begin{tightemize}
\item Identifying responsible gene-network for \custombold{long-term effect of Morphine-response} with anxiety of BXD RI mice family through generations.
\end{tightemize}
